...
<div class="auth-wrapper">
    ...
    <div class="auth-form">
        <div class="form-header">
            ...
            <p>Masuk untuk reservasi lapangan favoritmu</p>
        </div>

        <!-- Session Status -->
        @if(session('status'))
            <div class="alert-success" style="background:#d4edda;color:#155724;padding:12px 16px;border-radius:8px;border-left:4px solid #28a745;margin-bottom:16px;">
                ✅ {{ session('status') }}
            </div>
        @endif
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="form-group">
                ...
                <input type="email" name="email" id="email" placeholder="contoh@email.com" value="{{ old('email') }}" required autofocus>
                @error('email')
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 8px;">
                <div class="form-group checkbox" style="margin-bottom: 0;">
                    ...
                    <label for="remember">Ingatlah aku</label>
                </div>
